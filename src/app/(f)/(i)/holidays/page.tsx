...
const Page = async () => {
    const items = await getProductsByCategory('праздник');
            ...
            <section>
                <Container>
                    <div className="text-center mx-auto mb-[90px]">
                        <h2 className="font-pioner-sans text-[70px] text-foregroud-primary">Праздник</h2>
                        <p className="font-magnet text-[20px] leading-[30px] text-foregroud-tertiary">Букеты для праздничных мероприятий и торжеств</p>
                    </div>
