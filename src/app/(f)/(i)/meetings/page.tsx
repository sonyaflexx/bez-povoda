...
const Page = async () => {
    const items = await getProductsByCategory('свидание');
            ...
            <section>
                <Container>
                    <div className="text-center mx-auto mb-[90px]">
                        <h2 className="font-pioner-sans text-[70px] text-foregroud-primary">Свидание</h2>
                        <p className="font-magnet text-[20px] leading-[30px] text-foregroud-tertiary">Романтические букеты для свиданий и особых моментов</p>
                    </div>
